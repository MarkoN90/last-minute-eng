        ...
        <div class="my-4" id="tableExample" data-list="{&quot;valueNames&quot;:[&quot;name&quot;,&quot;email&quot;,&quot;age&quot;],&quot;page&quot;:5,&quot;pagination&quot;:true}">
            <div class="table-responsive scrollbar">
                <table class="table table-bordered table-striped fs--1 mb-0">
                    ...
                    <tr>
                        ...
                        <th class="sort" data-sort="">Date Of Subscription</th>
                    ...
                    @if(!$subscriptions->isEmpty())
                        ...
                        <tr>
                            <td class="name">{{ $subscription->first_name }} {{ $subscription->last_name }}</td>
                            <td class="email">{{ $subscription->email }}</td>
                            <td class="age">{{ $subscription->created_at }}</td>
                        </tr>
                        @endforeach
                    @endif
                    </tbody>
            ...
            <div class="row align-items-center mt-3">
                <div class="pagination d-none">
                    <li class="active"><button class="page" tseype="button" data-i="1" data-page="15">1</button></li>
                </div>
                <div class="col">
