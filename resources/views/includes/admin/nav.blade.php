        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="/posts/create" role="button" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
                    ...
                    <a class="nav-link" href="/subscriptions" role="button" data-bs-toggle="" aria-expanded="false">
                        <div class="d-flex align-items-center">
                                    <span class="nav-link-icon">
